...
- `components/RecruiterVoiceControl.tsx` and `lib/recruiter-voice.ts`: opt-in Web Speech control plus conservative English/Hinglish request slot collection; they ask for missing required data and never trigger email/calendar delivery.
