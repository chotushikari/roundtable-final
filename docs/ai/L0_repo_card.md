...
- Latest review: 2026-09-06 Google-only interviewer workspaces, recruiter-side resume/link workflow, action loading states, and separately routed completed analysis with saved artifact evidence.
