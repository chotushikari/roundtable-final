...
- `SIMLI_API_KEY` and `SIMLI_FACE_ID` (optional, server-only; enable presentation-only interviewer video while Agora remains the authoritative interview-audio pipeline)
